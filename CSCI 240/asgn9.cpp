/******************************************************************************
CSCI 240 - Program 9 - Spring 2008
...
Purpose: Create a program that will analyze an array using pointers.
******************************************************************************/
...
void doStatsAddr( int[], int, double*, int*, int*, int* );

void meanAndMedianAddr( int[], int, double*, int* );

void hiAndLoAddr( int[], int, int*, int* );
...
int main()
  ...
  doStatsAddr( ar, numScores, &mean, &median, &hi, &lo );
...
void doStatsAddr( int ar[], int numScores, double * mean, int * median, int * hi, int * lo )
  {
  int sortedAr[200],
  i;
  ...
  meanAndMedianAddr( sortedAr, numScores, mean, median );
  
  hiAndLoAddr( sortedAr, numScores, hi, lo );
  }
  
void meanAndMedianAddr( int sortedAr[], int numScores, double * mean, int * median )
  {
...
void hiAndLoAddr( int sortedAr[], int numScores, int * hi, int * lo )
  {
